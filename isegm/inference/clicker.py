...
class Clicker(object):
    ...
    def _get_next_click(self, pred_mask, padding=True):
        ...
        ## is_positive: bool, coords: (int, int)
        return Click(is_positive=is_positive, coords=(coords_y[0], coords_x[0]))

    def make_next_click_reefnet(self, coords_y, coords_x, is_positive):
        click = Click(is_positive=is_positive, coords=(coords_y, coords_x))
        self.add_click(click)
        ## is_positive: bool, coords: (int, int)
